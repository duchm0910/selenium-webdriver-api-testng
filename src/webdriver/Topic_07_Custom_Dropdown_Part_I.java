...
public class Topic_07_Custom_Dropdown_Part_I {
  ...
  public void TC_02_Angular() {
    ...
    selectItemCustomDropdown(
        "//ejs-dropdownlist[@id='games']//span[contains(@class,'e-search-icon')]",
        "//div[@id='games_popup']//li",
        "Hockey");
    sleepInSecond(3);
  ...
  public void TC_03_React() {
    ...
    selectItemCustomDropdown(
        "//div[@role='listbox']", "//div[@role='listbox']//span[@class='text']", "Matt");
    sleepInSecond(2);
    Assert.assertTrue(driver.findElement(By.xpath("//div[text()='Matt']")).isDisplayed());

    selectItemCustomDropdown(
        "//div[@role='listbox']", "//div[@role='listbox']//span[@class='text']", "Jenny Hess");
    sleepInSecond(2);
    Assert.assertTrue(driver.findElement(By.xpath("//div[text()='Jenny Hess']")).isDisplayed());

    selectItemCustomDropdown(
        "//div[@role='listbox']", "//div[@role='listbox']//span[@class='text']", "Justen Kitsune");
    sleepInSecond(2);
  ...
  public void TC_04_VueJS() {
    ...
    selectItemCustomDropdown(
        "//li[@class='dropdown-toggle']", "//ul[@class='dropdown-menu']//a", "Second Option");
    sleepInSecond(2);
    Assert.assertEquals(
        driver.findElement(By.xpath("//li[@class='dropdown-toggle']")).getText(), "Second Option");

    selectItemCustomDropdown(
        "//li[@class='dropdown-toggle']", "//ul[@class='dropdown-menu']//a", "First Option");
    sleepInSecond(2);
    Assert.assertEquals(
        driver.findElement(By.xpath("//li[@class='dropdown-toggle']")).getText(), "First Option");

    selectItemCustomDropdown(
        "//li[@class='dropdown-toggle']", "//ul[@class='dropdown-menu']//a", "Third Option");
    sleepInSecond(2);
    Assert.assertEquals(
        driver.findElement(By.xpath("//li[@class='dropdown-toggle']")).getText(), "Third Option");
  }
  ...
  public void TC_05_Edit() {
    ...
    selectItemEditDropdown(
        "//input[@class='search']", "//div[@role='combobox']//span[@class='text']", "Australia");
    sleepInSecond(2);
    Assert.assertTrue(driver.findElement(By.xpath("//div[text()='Australia']")).isDisplayed());

    selectItemEditDropdown(
        "//input[@class='search']", "//div[@role='combobox']//span[@class='text']", "Afghanistan");
    sleepInSecond(2);
    Assert.assertTrue(driver.findElement(By.xpath("//div[text()='Afghanistan']")).isDisplayed());

    selectItemEditDropdown(
        "//input[@class='search']", "//div[@role='combobox']//span[@class='text']", "Belgium");
    sleepInSecond(2);
  ...
  public void TC_06_Multiple_Custom_Dropdown() {
    driver.get(
        "http://multiple-select.wenzhixin.net.cn/templates/template.html?v=189&url=basic.html");
    selectMultiItemInDropdown(
        "(//button[@class='ms-choice'])[1]",
        "(//button[@class='ms-choice'])[1]/following-sibling::div//span",
        firstMonths);
    sleepInSecond(2);
  ...
  public void selectMultiItemInDropdown(
      String parentXpath, String childXpath, String[] expectedValueItem) {
  ...
  public boolean areItemSelected(String[] itemselectedText) {
    List<WebElement> itemSeltected =
        driver.findElements(By.xpath("//li[@class='selected']//input"));
    int numberItemSelected = itemSeltected.size();

    String allItemSelectedText =
        driver.findElement(By.xpath("//button[@class='ms-choice']/span[1]")).getText();
    ...
    if (numberItemSelected <= 3 && numberItemSelected > 0) {
      ...
      return driver
          .findElement(
              By.xpath(
                  "//button[@class='ms-choice']/span[text()='"
                      + numberItemSelected
                      + " of 12 selected']"))
          .isDisplayed();
    }
  ...
  public void selectItemCustomDropdown(
      String parentXpath, String allElementXpath, String expectedValueItem) {
  ...
  public void selectItemEditDropdown(
      String editableXpath, String allElementXpath, String expectedValueItem) {
    //       1 - Click vao 1 element(parentXpath) de cho no xo het cac item ra
  ...
  public String getAngularSelectedValueByJS() {
    return (String)
        jsExecutor.executeScript(
            "return document.querySelector(\"select[name='games'] option\").textContent");
  }
