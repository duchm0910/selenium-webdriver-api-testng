...
public class Topic_02_Xpath_Css_Part_II_FindElement {
  ...
  public void TC_02_Login_Invalid_Email() {
    ...
    Assert.assertEquals(
        getErrMessEmail, "Please enter a valid email address. For example johndoe@domain.com.");
  }
  ...
  public void TC_03_Login_Invalid_Password() {
    ...
    Assert.assertEquals(
        passErrMess, "Please enter 6 or more characters without leading or trailing spaces.");
  }
  ...
  public void TC_05_Login_Success() {
    ...
    //        Click Login button
    driver.findElement(By.name("send")).click();
    //        Get text My dashboard, Hello, Automation Testing!,Automation Testing,
    // automation_13@gmail.com
    String myDashboard = driver.findElement(By.className("page-title")).getText();
    String welmsg =
        driver
            .findElement(By.xpath("//div[@class='welcome-msg']//p[@class='hello']//strong"))
            .getText();
    Assert.assertEquals(myDashboard, "MY DASHBOARD");
    String contactInfo =
        driver
            .findElement(
                By.xpath("//div[@class='box-account box-info']//div[@class='box-content']"))
            .getText();
  ...
  public void TC_06_Register_To_System() {
    ...
    //        so sanh
    String msgSuccess =
        driver.findElement(By.xpath("//li[@class='success-msg']//ul//li//span")).getText();
    ...
    //       logout
    driver
        .findElement(By.xpath("//div[@class='account-cart-wrapper']//span[text()='Account']"))
        .click();
  ...
  @Test
  public void TC_07_Login_Valid_Email_Password() {
    getEmailAddress1 = emailAddress;
    // Click link my account
    driver.findElement(By.xpath("//div[@class='footer']//a[text()='My Account']")).click();
    //        nhap valid email password
    driver.findElement(By.name("login[username]")).sendKeys(getEmailAddress1);
    driver.findElement(By.id("pass")).sendKeys("123456");
    //        Click login
    driver.findElement(By.id("send2")).click();
    //        verify welcome messsage
    String welcomeMsg =
        driver.findElement(By.xpath("//div[@class='welcome-msg']//strong")).getText();
    Assert.assertEquals(
        welcomeMsg, "Hello, " + firstName + " " + middleName + " " + lastName + "!");
  }
